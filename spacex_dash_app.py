...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
    ...
    # Placeholder for payload range slider
    html.Br(),  
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        fig = px.pie(spacex_df, values='class', names='Launch Site', title='Success/Failure Count for All Sites')
    else:
        # Pie chart for a specific site
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site]
        fig = px.pie(filtered_df, values='class', names='class', title=f'Success/Failure Count for {entered_site}')
